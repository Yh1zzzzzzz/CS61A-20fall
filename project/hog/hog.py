        ...
        def gcd(a,b):
            while b!=a:
                if a>b:
                    ...
                    b-=a
            return a
        temp = gcd(player_score,opponent_score)
        return temp>=10
    # END PROBLEM 4a
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    #         now = s0-last_score
    #         if now>running_high:
    #             print('{} point(s)! The most yet for Player 0'.format(now))
    #             return announce_highest(who,s0,now)
    #         else:
    ...
    #         now = s1-last_score
    #         if now>running_high:
    #             print('{} point(s)! The most yet for Player 1'.format(now))
    #             return announce_highest(who,s0,now)
    #         else:
    #             return announce_highest(who,s0,running_high)
    #     return help1
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    for i in range(1,11):
        temp = roll_dice
        a = make_averaged(temp,trials_count)(i,dice)
        averange.append(a)
    big = max(averange)
    return (averange.index(big)  +1) 
...
def bacon_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    benefit = free_bacon(opponent_score)
    if  benefit>=cutoff:
        return 0
    else :
        return num_rolls
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    bene = free_bacon(opponent_score)
    temp_score = score+bene
